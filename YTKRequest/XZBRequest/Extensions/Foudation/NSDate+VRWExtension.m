...
@implementation NSDate (VRWExtension)
...
+ (NSInteger )chinaSystemCurrentTime
{
    NSDate *date = [NSDate date];
    UInt64 nowTimeStamp = [date timeIntervalSince1970];
    return nowTimeStamp;
}

+(NSDate *)getAfterYear:(NSInteger)year afterMonth:(NSInteger)month afterDay:(NSInteger)day nowDate:(NSDate *)nowDate
{
